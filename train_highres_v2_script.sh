...
python -m torch.distributed.launch --master_port=6667 --nproc_per_node=4 main_pretrain_custom_v2.py \
    --output_dir jobdir/highres_v2_nomask_vit_base_patch16_input112_combined_datasets \
    --log_dir jobdir/highres_v2_nomask_vit_base_patch16_input112_combined_datasets \
    --num_workers 8\
    --batch_size 256 \
    --model mae_vit_base_patch16 \
    --input_size 112 \
